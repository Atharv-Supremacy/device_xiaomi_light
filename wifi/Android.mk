...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.light.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.light.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.light
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.light.rc \
    android.hardware.wifi@1.0-service.light.xml
